...
EasyBacklogControllerImpl.prototype.getSprintStories = function(sprintId, callBackFail, callBackSuccess) {
    this.easyBacklogImpl.call("/sprints/"+sprintId+"/sprint-stories.json", callBackSuccess, callBackFail);
};